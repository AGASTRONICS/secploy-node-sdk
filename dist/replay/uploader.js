...
exports.SegmentUploader = void 0;
exports.fetchWithTimeout = fetchWithTimeout;
exports.replaySegmentEvent = replaySegmentEvent;
const failed = (failure, permanent = false) => ({ objectKey: null, failure, permanent });
/**
...
class SegmentUploader {
    ...
    async upload(args) {
        ...
        let minted;
        try {
            minted = await fetchWithTimeout(this.fetchImpl, `${this.apiUrl}/projects/replay/upload-url/`, {
                method: "POST",
        ...
        if (!uploadUrl || !objectKey)
            return failed("transient");
        try {
            const put = await fetchWithTimeout(this.fetchImpl, uploadUrl, {
                method: "PUT",
...
exports.SegmentUploader = SegmentUploader;
/**
 ...
 * nobody can find.
 */
function replaySegmentEvent(args) {
