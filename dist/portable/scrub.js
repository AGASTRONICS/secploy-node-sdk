...
exports.Scrubber = exports.HASHED_SESSION = exports.MAX_STRING = exports.MAX_ITEMS = exports.MAX_DEPTH = exports.EXEMPT_KEYS = exports.DEFAULT_DENY_KEYS = exports.REDACTED = void 0;
exports.normalizeKey = normalizeKey;
exports.scrubString = scrubString;
exports.REDACTED = "[secploy:redacted]";
/**
...
function redactCards(text) {
    ...
    return text.replace(CARD_CANDIDATE, (match) => luhnValid(match.replace(/[ -]/g, "")) ? exports.REDACTED : match);
}
...
function scrubString(value) {
    ...
    for (const pattern of VALUE_PATTERNS) {
        pattern.lastIndex = 0;
        scrubbed = scrubbed.replace(pattern, exports.REDACTED);
    }
    scrubbed = redactCards(scrubbed);
    if (scrubbed.length > exports.MAX_STRING) {
        scrubbed = scrubbed.slice(0, exports.MAX_STRING) + "…[truncated]";
    }
    return scrubbed;
}
...
class Scrubber {
    constructor(options = {}) {
        ...
        this.denyKeys = new Set(exports.DEFAULT_DENY_KEYS);
    ...
    isDenied(key) {
        ...
        if (!normalized || exports.EXEMPT_KEYS.has(normalized))
            return false;
        if (this.denyKeys.has(normalized))
            return true;
        ...
        for (const denied of this.denyKeys) {
            if (denied.length >= 5 && normalized.includes(denied))
                return true;
        }
        return false;
    }
