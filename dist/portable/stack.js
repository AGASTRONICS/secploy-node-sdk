...
exports.defaultModuleOf = defaultModuleOf;
 ...
 */
function defaultModuleOf(filename) {
 ...
 */
function parseStack(stack, moduleOf = defaultModuleOf, options = {}) {
    if (!stack)
        return [];
    const frames = [];
    for (const line of stack.split("\n")) {
        ...
        const gecko = withFunction || bare || native || !options.gecko
            ? null
...
function parseError(thrown, moduleOf = defaultModuleOf, options = {}) {
